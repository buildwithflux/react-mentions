...
var MentionsInput = /*#__PURE__*/function (_React$Component) {
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderControl", function () {
      ...
      return /*#__PURE__*/React.createElement("div", style('control'), _this.renderHighlighter(), renderInput ? _this.renderCustom(inputProps) : singleLine ? _this.renderInput(inputProps) : _this.renderTextarea(inputProps));
    });

    _defineProperty(_assertThisInitialized(_this), "renderCustom", function (props) {
      var RenderInput = _this.props.renderInput;
      return /*#__PURE__*/React.createElement(RenderInput, _extends({
