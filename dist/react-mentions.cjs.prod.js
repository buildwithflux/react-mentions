...
var makeTriggerRegex = function(trigger) {
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setContainerElement", function(el) {
      ...
      var _this$props2 = _this.props, singleLine = _this$props2.singleLine, style = _this$props2.style, renderInput = _this$props2.renderInput, inputProps = _this.getInputProps();
      return React__default.createElement("div", style("control"), _this.renderHighlighter(), renderInput ? _this.renderCustom(inputProps) : singleLine ? _this.renderInput(inputProps) : _this.renderTextarea(inputProps));
    }), _defineProperty(_assertThisInitialized(_this), "renderCustom", function(props) {
      var RenderInput = _this.props.renderInput;
      return React__default.createElement(RenderInput, _extends({
