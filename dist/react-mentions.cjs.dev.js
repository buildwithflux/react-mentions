  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderControl", function () {
      var _this$props2 = _this.props,
          ...
          renderInput = _this$props2.renderInput;

      var inputProps = _this.getInputProps();

      return /*#__PURE__*/React__default.createElement("div", style('control'), _this.renderHighlighter(), renderInput ? _this.renderCustom(inputProps) : singleLine ? _this.renderInput(inputProps) : _this.renderTextarea(inputProps));
    });

    _defineProperty(_assertThisInitialized(_this), "renderCustom", function (props) {
      var RenderInput = _this.props.renderInput;
      return /*#__PURE__*/React__default.createElement(RenderInput, _extends({
